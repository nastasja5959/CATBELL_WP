...
<section class="page-shopDetail">
  ...
  <section class="access">
    <div class="inner">
      <h2 class="section__title">新宿店の基本情報</h2>
      <div class="access__inner">
        <div class="access__text">
          <dl>
            <dt>住所</dt>
            <dd>東京都新宿区西新宿2-22-2キャットベル</dd>
            <dt>TEL</dt>
            <dd>22-2222-2222</dd>
            <dt>営業時間</dt>
            ...
            <dt>アクセス</dt>
            <dd>電車でお越しのお客様</dd>
            <dd>JR線「新宿駅」より徒歩約5分</dd>
            <dd>西武新宿線「新宿駅」より徒歩約5分</dd>
            <dd>京王線京王新線・小田急線「新宿駅」より徒歩約10分</dd>
            <dd>東京メトロ丸ノ内線「新宿駅」より徒歩約10分</dd>
            <dd>お車でお越しのお客様</dd>
            <dd>首都高速4号新宿線「新宿I.C.」より約10分</dd>
          </dl>
        </div><!-- access__text -->
  ...
  <section class="catlist">
    <div class="inner">
      <h2 class="section__title">新宿店の新入りの猫ちゃん</h2>
    ...
    <div class="inner">
      ...
      <div class="concept__inner">
        ...
        <div class="concept__right">
          ...
          <p class="concept__text">こんにちは！CTABELL 新宿店です。当サロンでは、最新の道具と定期的なトリマーの研修を行い、飼い主さまにもペットにも優しいトリミングとサービスをご提供できるように日々努めています。
            また、健康状態のチェックや皮膚の状態をチェックするのは、トリミングを行う前にとても大切ですので、きちんと確認を行った上で、その子に合った最適なスタイルをご提案させていただきます。ご要望などがありましたら、お気軽にお申し付けください。スタッフ一同常に笑顔で皆さまのご来店をお待ちしています。</p>
        </div><!-- concept__right -->
      </div><!-- concept__inner -->
    </div><!-- inner -->
  </section><!-- concept -->
  ...
  <section class="blog">
    <div class="inner">
      <h2 class="section__title">新宿店の最新ブログ</h2>
